...
**Current API readiness:** unavailable as of `2026-08-29`
([readiness endpoint](https://dax591xorok0e.cloudfront.net/api/readyz))

> **Current availability note (`2026-08-29`):** the static frontend returned HTTP
> 200, while the API readiness endpoint returned HTTP 503 with its database check
> unavailable. The successful deployment and health results below are explicitly
> historical measurements captured for the v0.1 release; they are not a claim of
...
value. The current API availability is stated separately above.
